import { Direction, Suit } from "$lib/types/cards";
import getTrayInfo from "$lib/bridge/utils/getTrayInfo";
...
import { Char, FileType } from "$lib/types/bridge";
import type { LookupEntry } from "$lib/bridge/utils/getTrayInfo";
